"""
v4 data preparation — chronological split at step 595, causal F8, F11 dropped.

Reads the v2 preprocessed CSVs, recovers `step`, rebuilds F8 using a
train-partition-only percentile, drops F11, and caches per-stratum arrays.

Writes ONLY under results/v4/. No v3 artifact is touched.
"""
