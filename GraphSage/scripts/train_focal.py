...
def main() -> None:
    ...
    # Focal Loss prior init — Lin et al. 2017. Use the *training* fraud rate so
    # the initial classifier bias matches the prior and the optimiser starts
    # from a stable point instead of sigmoid(0)=0.5.
