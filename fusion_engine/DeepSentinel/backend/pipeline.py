    ...
    *,
    ...
    with _Timer() as t:
        if use_mock:
            ...
            temporal_predecessor = t_resp.extra.get("triggering_predecessor") or None
            temporal_evidence = (
                {**temporal_predecessor, "step_burstiness": t_resp.extra.get("step_burstiness")}
                if temporal_predecessor
                else None
            )
