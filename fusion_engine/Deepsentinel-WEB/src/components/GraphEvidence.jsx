        ...
        <div className="mt-6">
          ...
          <div className="mt-3 -mx-1 overflow-x-auto px-1">
            <table className="w-full min-w-[34rem] text-left text-xs">
              <thead>
                <tr className="text-[14px] uppercase tracking-wider text-slate-500">
              ...
              <tbody>
                {shown.map((e, i) => {
                  ...
                  return (
                    ...
                    >
                      <td className="py-2 pr-3 font-mono text-[15px] text-slate-400">
                        {e.src}
                        {e.is_trigger_edge && (
                          <span className="ml-1.5 rounded bg-accent-500/15 px-1 py-px text-[13px] font-semibold uppercase tracking-wide text-accent-400">
                            trigger
                          </span>
                        )}
                      </td>
                      ...
                      <td className="py-2 text-right font-mono text-[15px] text-slate-200">
                        {fmtAmount(e.amount)}
                      </td>
                      <td className="py-2 pl-3">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="shrink-0 font-mono text-[14px] text-slate-500">
                            {w.toFixed(3)}
                          </span>
                        </div>
                      </td>
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            {nodes.slice(0, showAll ? nodes.length : 14).map((n) => (
              <span
                ...
                className={cx(
                  'rounded-md border border-subtle bg-surface px-2 py-1 font-mono text-[14px]',
            ...
            {!showAll && nodes.length > 14 && (
              <span className="px-2 py-1 text-[14px] text-slate-500">
