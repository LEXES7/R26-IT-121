            ...
            {MODELS.map((m) => (
              ...
              >
                <div className="flex items-baseline justify-between gap-3">
                  ...
                  <span className="font-mono text-[12px] text-slate-600">{m.model}</span>
                </div>
                ...
                <div
                  ...
                  style={{ height: 0 }}
                >
                  <p className="pt-2 text-[13px] leading-snug text-slate-400">{m.finding}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="story-report mt-5 rounded-xl border border-subtle bg-sentinel-950 p-3 opacity-0">
            ...
            <div className="mt-2 space-y-1">
              {REPORT.map((line, i) => (
                <p
                  key={line}
                  className={`story-report-line font-mono text-[13px] leading-relaxed opacity-0 ${
