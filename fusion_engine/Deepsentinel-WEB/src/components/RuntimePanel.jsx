  ...
  return (
    <section>
      <div className="flex items-baseline justify-between">
        ...
        <span className="text-[12px] text-slate-600">{live}/3 reachable</span>
      </div>
          ...
          return (
            <div key={key} className="py-2.5">
              <div className="flex items-baseline gap-2">
                ...
                <span className={cx('ml-auto text-[12px]',
                  reachable && !ready ? 'text-risk-medium' : 'text-slate-600')}>
                  {state}
                </span>
              </div>
              <p className="mt-0.5 pl-3.5 text-[12px] text-slate-600">{role}</p>

              {reachable && model && (
                <dl className="mt-2 grid grid-cols-3 gap-2 pl-3.5 text-[12px]">
                  <div>
              ...
              {!ready && (
                <p className="mt-1 pl-3.5 text-[12px] leading-relaxed text-slate-600">
                  {!reachable
