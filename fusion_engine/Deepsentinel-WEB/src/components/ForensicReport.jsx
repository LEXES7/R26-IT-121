    ...
    <Card className="p-5 sm:p-6">
      ...
      {plain && (
        <div className="mt-5 rounded-xl border border-accent-500/25 bg-accent-500/[0.06] p-5">
          <div className="flex items-start justify-between gap-3">
            <p className="text-[12px] font-semibold uppercase tracking-wider text-accent-400">
              In plain language
            </p>
            <button
              onClick={() => setPlain(null)}
              className="shrink-0 text-[13px] text-slate-500 hover:text-slate-300 print:hidden"
            >
              hide
            </button>
          </div>
      ...
      >
        ...
        <div className="border-b border-subtle pb-4">
          ...
          {!grounded && (
            <p className="mt-2 text-[13px] font-medium text-risk-medium">
        ...
        <p className="mt-6 border-t border-subtle pt-3 text-[12px] leading-relaxed text-slate-500">
