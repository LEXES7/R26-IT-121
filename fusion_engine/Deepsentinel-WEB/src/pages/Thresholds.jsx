              ...
              <div style={{ display: 'grid', gap: 12, alignContent: 'start' }}>
                ...
                <Panel className="ds-panel-pad">
                  <div className="hair-b flex flex-wrap items-baseline justify-between gap-3 pb-2.5">
                    ...
                    <span className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[15px] text-slate-500">
                      {hasLabels ? (
                        <>
                  ...
                  <div className="mt-5">
                    ...
                    />
                    <div className="mt-1 flex justify-between text-[14px] text-slate-600">
                ...
                <Panel className="ds-panel-pad">
                  ...
                  {selected === 'fused' && live && (
                    <div style={{ marginTop: 14, paddingTop: 13,
                      ...
                      <div style={{ fontSize: 13, color: 'rgb(var(--ds-faint))',
                                    marginBottom: 11 }}>
...
function Curve({ curve, point, maxAlerts, hasLabels, onPick }) {
  return (
    <>
        ...
        {curve.map((p) => {
          ...
          return (
            ...
            >
              ...
              <span className="numeric pointer-events-none absolute -top-5 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded bg-surface-overlay px-1.5 py-0.5 text-[13px] text-slate-200 opacity-0 transition-opacity group-hover:opacity-100">
                {p.alerts}
              </span>
            </button>
          )
      ...
      <div className="hair-t mt-1.5 flex justify-between pt-1.5 text-[14px] text-slate-600">
      ...
      <div className="mt-5 grid gap-5 sm:grid-cols-3">
        {parts.map(([label, n, hex, note]) => (
          <div key={label}>
            ...
            <p className="mt-1 text-[14px] leading-relaxed text-slate-600">{note}</p>
          </div>
        ))}
      </div>
    </>
...
function Row({ label, value }) {
  return (
    <div className="flex items-baseline justify-between py-1.5 text-[15px]">
