          ...
          <ol className="mt-3 space-y-2.5">
            {[
              ...
              <li key={n} className="flex gap-3">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-accent-500/15 text-[12px] font-bold text-accent-500">
                  {n}
                </span>
                <span>
                  <span className="block text-xs font-medium text-slate-300">{title}</span>
                  <span className="block text-[13px] leading-relaxed text-slate-600">{detail}</span>
                </span>
              </li>
            ))}
          </ol>
          <p className="mt-3 border-t border-subtle pt-3 text-[13px] leading-relaxed text-slate-600">
